              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/lamb skin bag (1).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/lamb skin bag (2).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/lamb skin bag (3).jpg" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/jpg/lamb skin bag (1).jpg",
      thumbs: [
        "img/jpg/lamb skin bag (1).jpg",
        "img/jpg/lamb skin bag (2).jpg",
        "img/jpg/lamb skin bag (3).jpg"
      ]
    };
  },
  methods: {
