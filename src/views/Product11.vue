              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/bridesmaid clutch (1).png" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/bridesmaid clutch (2).png" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/bridesmaid clutch (3).png" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/bridesmaid clutch (1).png",
      thumbs: [
        "img/bridesmaid clutch (1).png",
        "img/bridesmaid clutch (2).png",
        "img/bridesmaid clutch (3).png"
      ]
    };
  },
  methods: {
