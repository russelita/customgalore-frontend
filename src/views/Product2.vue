              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/sammo leather clutch (1).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/sammo leather clutch (2).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/sammo leather clutch (3).jpg" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/sammo leather clutch (1).jpg",
      thumbs: [
        "img/sammo leather clutch (1).jpg",
        "img/sammo leather clutch (2).jpg",
        "img/sammo leather clutch (3).jpg"
      ]
    };
  },
  methods: {
