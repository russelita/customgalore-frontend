              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/agenda cover (1).png" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/agenda cover (2).png" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/agenda cover (1).png",
      thumbs: ["img/agenda cover (1).png", "img/agenda cover (2).png"]
    };
  },
  methods: {
