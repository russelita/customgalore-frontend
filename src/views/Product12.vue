              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/agenda cover (1).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/agenda cover (2).jpg" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/agenda cover (1).jpg",
      thumbs: ["img/agenda cover (1).jpg", "img/agenda cover (2).jpg"]
    };
  },
  methods: {
