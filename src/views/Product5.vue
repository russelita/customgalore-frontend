              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/maria wallet (1).png" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/maria wallet (2).png" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/maria wallet (1).png",
      thumbs: ["img/maria wallet (1).png", "img/maria wallet (2).png"]
    };
  },
  methods: {
