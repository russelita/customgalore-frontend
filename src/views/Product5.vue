              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/maria wallet (1).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/maria wallet (2).jpg" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/maria wallet (1).jpg",
      thumbs: ["img/maria wallet (1).jpg", "img/maria wallet (2).jpg"]
    };
  },
  methods: {
