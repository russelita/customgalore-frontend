              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/morgan clutch (1).jpg" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/morgan clutch (2).jpg" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/morgan clutch (1).jpg",
      thumbs: ["img/morgan clutch (1).jpg", "img/morgan clutch (2).jpg"]
    };
  },
  methods: {
