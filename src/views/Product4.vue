              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/morgan clutch (1).png" alt />
                    </div>
                    <div
                      class="pt"
                    ...
                    >
                      <img src="img/morgan clutch (2).png" alt />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/morgan clutch (1).png",
      thumbs: ["img/morgan clutch (1).png", "img/morgan clutch (2).png"]
    };
  },
  methods: {
